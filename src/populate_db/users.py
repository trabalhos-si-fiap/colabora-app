...
class PopulateRawDB:
    ...
    def populate_users(self) -> None:
        ...
        logger.info(f'Tabela de Usuários populada com {self.user_repository.count()} usuários.')
    ...
    def populate_habilities(self) -> None:
        ...
        logger.info(f'Banco de dados populado com {self.hability_repository.count()} habilidades.')
